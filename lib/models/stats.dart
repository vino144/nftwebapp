...
class Stats {
  ...
  final int one_day_volume;
  final int one_day_change;
  final int one_day_sales;
  final int one_day_average_price;
  final int seven_day_volume;
  final int seven_day_change;
  final int seven_day_sales;
  final int seven_day_average_price;
  final int thirty_day_volume;
  final int thirty_day_change;
  final int thirty_day_sales;
  final int thirty_day_average_price;
